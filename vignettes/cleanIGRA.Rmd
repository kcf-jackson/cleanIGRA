...
1. ```fix_data_type``` converts some of the measurement variables from characters strings to numeric values and labels missing data (marked as -8888 and -9999) as NA.
