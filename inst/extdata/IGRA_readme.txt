Integrated Global Radiosonde Archive (IGRA) Readme File 
...
files available.
The current official version of IGRA is v1.20.2014, indicating that the 
the sounding data beginning on January 1, 2014, are reprocessed and updated
with the most recent data on a daily basis and are then appended to the 
base version of the dataset that ends on December 31, 2013.
details on this processing arrangement, see Durre et al. (2006, J. Climate).

In addition to the current official version of IGRA, this directory also
contains a beta version of IGRA v2. All v2beta files are located in
subdirectory v2beta, while all files and directories outside of that
subdirectory pertain to v1.20. Information about v2beta can be found in
the igra2-readme.txt file in the v2beta subdirectory.
...
data-por     v1.20 period-of-record data files (base version through 2013 + 
             daily updates; one file per station)
data-y2d     V1.20 daily updates since January 1, 2014 (replaced daily; 
             one file per station)
derived-v2   IGRA-derived parameters computed from v1.20 data (includes 
             period-of-record station files and documentation).
monthly-por  V1.20 period-of-record monthly-mean files (updated monthly)
monthly-upd  Files of monthly means for the last month only (replaced monthly)
v2beta       IGRA v2beta, including sounding data, monthly means, derived
             parameters, station metadata, and documentation.

---------------------------------
Files:
---------------------------------

igra-composites.txt            IGRA v1.20 stations with composited records
igra-countries.txt             List of country codes used in the v1.20
                               station list
igra-metadata.txt              IGRA v1.20 station history and metadata inventory
...
igra-stations.txt              List of stations in IGRA v1.20
