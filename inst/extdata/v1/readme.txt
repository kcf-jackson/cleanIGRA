Integrated Global Radiosonde Archive (IGRA) Version 1 Readme File
...
This file lists the contents of the IGRA Version 1 FTP directory
and describes the format of the IGRA 1 various sounding, monthly-mean,
and station inventory files available.
The current official version of IGRA is v2
(see http://www1.ncdc.noaa.gov/pub/data/igra/igra2-readme.txt).
Version 1 is no longer updated and is offered merely for comparison and for
users who have not yet switched to the IGRA 2 format.


II. Contents of ftp://ftp.ncdc.noaa.gov/pub/data/igra/v1/
